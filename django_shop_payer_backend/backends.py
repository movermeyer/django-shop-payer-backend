...
class PayerCreditCardPaymentBackend(ForwardFundBackend):

    url_namespace = 'payer-creditcard'
...
class PayerBankPaymentBackend(ForwardFundBackend):

    url_namespace = 'payer-bankpayment'
